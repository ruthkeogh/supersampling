...
# Must have interaction=T. For interaction=F use analysis_casecohort_interactionF.R
#===============================
...
summary_approx = summary(pool(models))

caco.MIapprox.full.coef= summary_approx[,"estimate"]
caco.MIapprox.full.se= summary_approx[,"std.error"]
...
method.vec=rep("",dim(cohort.caco)[2])
method.vec[which(colnames(cohort.caco)=="x")]="norm"
method.vec[which(colnames(cohort.caco)=="xz1int")]="x*z1"

#initial values for x
inits<-complete(imp,1)$x

#perform the imputation
imp <- smcfcs.red(cohort.caco, smtype="coxph", smformula="Surv(t,d)~x+z1+z2+xz1int",method=method.vec,
...
method.vec=rep("",dim(cohort.super1.caco)[2])
method.vec[which(colnames(cohort.super1.caco)=="x")]="norm"
method.vec[which(colnames(cohort.super1.caco)=="xz1int")]="x*z1"
...
#perform the imputation
imp <- smcfcs.casecohort.red.Prentice(cohort.super1.caco,smformula="Surv(t,d)~x+z1+z2+xz1int",sampfrac=my.sampfrac,in.subco="subco.super1",
...
#perform the imputation
imp <- smcfcs.casecohort.red.LinYing(cohort.super1.caco,smformula="Surv(t,d)~x+z1+z2+xz1int",sampfrac=my.sampfrac,in.subco="subco.super1",
                                     method=method.vec,cohort.size=n,predictorMatrix=pred.mat,m=nimp,numit=nit.smc,rjlimit=10000,noisy=FALSE)
...
method.vec=rep("",dim(cohort.super2.caco)[2])
method.vec[which(colnames(cohort.super2.caco)=="x")]="norm"
method.vec[which(colnames(cohort.super2.caco)=="xz1int")]="x*z1"
...
#perform the imputation
imp <- smcfcs.casecohort.red.Prentice(cohort.super2.caco,smformula="Surv(t,d)~x+z1+z2+xz1int",sampfrac=my.sampfrac,in.subco="subco.super2",
                                      method=method.vec,cohort.size=n,predictorMatrix=pred.mat,m=nimp,numit=nit.smc,rjlimit=10000,noisy=FALSE)
...
#perform the imputation
imp <- smcfcs.casecohort.red.LinYing(cohort.super2.caco,smformula="Surv(t,d)~x+z1+z2+xz1int",sampfrac=my.sampfrac,in.subco="subco.super2",
                                     method=method.vec,cohort.size=n,predictorMatrix=pred.mat,m=nimp,numit=nit.smc,rjlimit=10000,noisy=FALSE)

...
minx<-min(cohort.ncc$x,na.rm=T)
cohort.ncc$logx<-ifelse(rep(minx,n)<0,log(cohort.ncc$x-minx+0.1),log(cohort.ncc$x))
...
#method of imputation for x
method.vec=rep("",dim(cohort.ncc)[2])
method.vec[which(colnames(cohort.ncc)=="x")]="exp(logx)"
method.vec[which(colnames(cohort.ncc)=="logx")]="norm"
...
minx<-min(ncc.super1$x,na.rm=T)
ncc.super1$logx<-ifelse(rep(minx,dim(ncc.super1)[1])<0,log(ncc.super1$x-minx+0.1),log(ncc.super1$x))
...
#method of imputation for x
method.vec=rep("",dim(ncc.super1)[2])
method.vec[which(colnames(ncc.super1)=="x")]="exp(logx)"
method.vec[which(colnames(ncc.super1)=="logx")]="norm"
...
minx<-min(ncc.super2$x,na.rm=T)
ncc.super2$logx<-ifelse(rep(minx,dim(ncc.super1)[1])<0,log(ncc.super2$x-minx+0.1),log(ncc.super2$x))
...
#method of imputation for x
method.vec=rep("",dim(ncc.super2)[2])
method.vec[which(colnames(ncc.super2)=="x")]="exp(logx)"
method.vec[which(colnames(ncc.super2)=="logx")]="norm"
